...
public abstract class Hilt_IntruderListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_IntruderListFragment() {
    super();
  }

  Hilt_IntruderListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((IntruderListFragment_GeneratedInjector) this.generatedComponent()).injectIntruderListFragment(UnsafeCasts.<IntruderListFragment>unsafeCast(this));
    }
  }
